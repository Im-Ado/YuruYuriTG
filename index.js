...
class AntiSpamSystem {
    constructor() {
        ...
        this.config = {
            maxMessagesPerUser: 3,          // Máximo 3 mensajes por usuario
            timeWindow: 10000,              // En ventana de 10 segundos
            globalCooldown: 2000,           // 2 segundos entre respuestas del bot
            userCooldown: 5000,             // 5 segundos de cooldown por usuario tras spam
            maxConsecutiveMessages: 2,       // Máximo 2 mensajes consecutivos del bot
            consecutiveTimeWindow: 3000      // Ventana de 3 segundos para mensajes consecutivos
        };
